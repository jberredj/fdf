...
#    Updated: 2021/07/09 16:33:00 by jberredj         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
GEOMETRY	=	vec2.c vec3.c vec4.c bresenham_line.c triangle.c vec3d_rotate.c

ARWING		=	arwing.c arwing_faces.c arwing_vertices.c
...
MODULE	=	main mlx_utils geometry arwing 3dobj
...
arwing: objs
	$(CC) $(CFLAGS) $(HEADERS) -c $(addprefix srcs/arwing/, $(ARWING)) $(DEBUG)
	mv *.o objs
